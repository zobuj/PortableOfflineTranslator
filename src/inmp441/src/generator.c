...
// #define FREQ_LEFT 460.0     // Left channel frequency (Hz)
// #define FREQ_RIGHT 660.0    // Right channel frequency (Hz)
// #define AMPLITUDE 8388607   // Max amplitude for 24-bit PCM (2^23 - 1)
...
//     struct timespec ts;
//     ts.tv_sec = 0;
//     ts.tv_nsec = 20833;  // 1/48000 sec in nanoseconds

//     int num_samples = SAMPLE_RATE * DURATION;
//     for(int i = 0; i < num_samples; i++) {
//         double t = (double)i / SAMPLE_RATE;

//         int32_t left_sample = (int32_t)(AMPLITUDE * cos(2.0 * M_PI * FREQ_LEFT * t));
//         int32_t right_sample = (int32_t)(AMPLITUDE * sin(2.0 * M_PI * FREQ_RIGHT * t));
...
//     close(sock_fd);
//     printf("I2S Transmitter (Audio Source) closed\n");
//     return EXIT_SUCCESS;
// }
